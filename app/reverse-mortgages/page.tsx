                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#1F2937]" style={{ lineHeight: '1.7' }}>
                      I'm not a financial advisor. I'm just someone who spent hundreds of hours reading what real people experienced with reverse mortgages. This guide is based on 30,000+ real stories from seniors and their families.
                    </p>
                  </div>
                </div>
              </div>
