...
import { getAllArticles, getArticleBySlug, getRelatedArticles, CATEGORY_COLORS } from '@/lib/articles';
    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-2">&ldquo;{article.title}&rdquo;</p>
          <p className="text-gray-500 mb-8">We&apos;re still analyzing community data for this article. Check back soon!</p>
          <Link
            href="/articles"
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24">
              ...
              <div className="mt-8 bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-100 rounded-lg p-6">
                <h3 className="font-bold text-lg mb-2 text-gray-900">Stay Updated</h3>
                <p className="text-sm text-gray-600 mb-4">Get weekly insights from real community data.</p>
                <Link
                  href="/newsletter"
