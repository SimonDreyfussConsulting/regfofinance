// components/CategoryNews.tsx
// Enhanced news section with thumbnails - to be placed mid-page
// Server component version - fetches articles directly
import Link from 'next/link';
import Image from 'next/image';
import { getLatestArticles, CATEGORY_COLORS } from '@/lib/articles';
...
export default function CategoryNews({ category, limit = 3, title = "Latest News & Insights" }: CategoryNewsProps) {
  const articles = getLatestArticles(limit, category);
